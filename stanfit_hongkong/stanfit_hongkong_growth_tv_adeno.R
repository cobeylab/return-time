...
stanfit_hongkong_growth_tv_adeno <- sampling(model,
                                         data = standata,
                                         seed=101,
                                         chain=4,
                                         cores=4,
...
check_hmc_diagnostics(stanfit_hongkong_growth_tv_adeno)
get_num_divergent(stanfit_hongkong_growth_tv_adeno)
get_num_max_treedepth(stanfit_hongkong_growth_tv_adeno)
get_low_bfmi_chains(stanfit_hongkong_growth_tv_adeno)
get_bfmi(stanfit_hongkong_growth_tv_adeno)

save("stanfit_hongkong_growth_tv_adeno", file="stanfit_hongkong_growth_tv_adeno.rda")

ss <- summary(stanfit_hongkong_growth_tv_adeno)
