...
stanfit_hongkong_growth_tv_rsv <- sampling(model,
                                         data = standata,
                                         seed=101,
                                         chain=4,
                                         cores=4,
...
check_hmc_diagnostics(stanfit_hongkong_growth_tv_rsv)
get_num_divergent(stanfit_hongkong_growth_tv_rsv)
get_num_max_treedepth(stanfit_hongkong_growth_tv_rsv)
get_low_bfmi_chains(stanfit_hongkong_growth_tv_rsv)
get_bfmi(stanfit_hongkong_growth_tv_rsv)

save("stanfit_hongkong_growth_tv_rsv", file="stanfit_hongkong_growth_tv_rsv.rda")

ss <- summary(stanfit_hongkong_growth_tv_rsv)
