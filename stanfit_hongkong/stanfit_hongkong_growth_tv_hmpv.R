...
stanfit_hongkong_growth_tv_hmpv <- sampling(model,
                                         data = standata,
                                         seed=101,
                                         chain=4,
                                         cores=4,
...
check_hmc_diagnostics(stanfit_hongkong_growth_tv_hmpv)
get_num_divergent(stanfit_hongkong_growth_tv_hmpv)
get_num_max_treedepth(stanfit_hongkong_growth_tv_hmpv)
get_low_bfmi_chains(stanfit_hongkong_growth_tv_hmpv)
get_bfmi(stanfit_hongkong_growth_tv_hmpv)

save("stanfit_hongkong_growth_tv_hmpv", file="stanfit_hongkong_growth_tv_hmpv.rda")

ss <- summary(stanfit_hongkong_growth_tv_hmpv)
