...
for (i in 1:length(realname)) {
  ...
  n.fnn <- fnn(logcases_pre, dmax=25, tau=tau, R_tol=5)
...
analysis_canada_takens_acf_fnn_th <- reslist %>%
  bind_rows

save("analysis_canada_takens_acf_fnn_th", file="analysis_canada_takens_acf_fnn_th.rda")
