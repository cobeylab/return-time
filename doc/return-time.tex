...
\begin{figure}[!ht]
\includegraphics[width=\textwidth]{../figure_schematic/figure_schematic_alternative.pdf}
\caption{
...
We find an increase in $\mathcal R_0$ and a decrease in duration of immunity correspond to an increase in pathogen resilience (Figure 4A).
...
Finally, we can now rank different pathogens based on the average values of empirical resilience, which allows us to determine a set of parameters that are consistent with the estimated resilience (Figure 4A).
