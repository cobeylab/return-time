...
\swp{There was substantial uncertainty about the dynamics of non-COVID pathogens in the wake of 2020, and we saw different patterns of return in different countries, and we don't have a good theory to understand if we should see persistent differences. We now see signals of some persistent differences, but too soon to say for many.}
...
These heterogeneities raised questions about what factors determine these re-emergence patterns and whether we will see persistent changes in pathogen dynamics following the pandemic \citep{kissler2020projecting,baker2022long,chow2023effects}.
However, a limited understanding of pre-pandemic dynamics of common respiratory pathogens have so far limited our ability to answer these questions and further tease apart how different factors contribute to heterogeneities in their re-emergence patterns.

More than five years have passed since the emergence of SARS-CoV-2, and we now have potential evidence for fundamental changes in pathogen dynamics following the pandemic, which likely reflect permanent changes in either human behavior or population-level immunity \citep{kissler2020projecting,baker2022long}.
