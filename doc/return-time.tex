...
(A, D, G, J) Simulated data (red points) and model fits (black lines).
Shaded regions represent the 95\% credible intervals.
(B, E, H, K) Assumed reductions in transmission rate due to COVID-19 interventions and inferred values of relative changes in transmission from model fits.
Red lines represent the true (assumed) values.
Black lines and shaded regions represent model fits and corresponding 95\% credible intervals.
(C, F, I, L) 
}
\end{figure}
