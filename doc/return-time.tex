...
We note that the intrinsic resilience is not the sole determinant for how sensitive the system is to stochastic perturbations.
...
% \swp{say something about smoothing.}
...
Red lines represent stochastic epidemic epidemic trajectories.
