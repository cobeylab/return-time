...
get_num_divergent(stanfit_sir_bhattacharyya)
get_num_max_treedepth(stanfit_sir_bhattacharyya)
get_low_bfmi_chains(stanfit_sir_bhattacharyya)
get_bfmi(stanfit_sir_bhattacharyya)
