...
check_hmc_diagnostics(stanfit_sir_bhattacharyya2)
get_num_divergent(stanfit_sir_bhattacharyya2)
get_num_max_treedepth(stanfit_sir_bhattacharyya2)
get_low_bfmi_chains(stanfit_sir_bhattacharyya2)
get_bfmi(stanfit_sir_bhattacharyya2)

save("stanfit_sir_bhattacharyya2", file="stanfit_sir_bhattacharyya2.rda")

ss <- summary(stanfit_sir_bhattacharyya2)
